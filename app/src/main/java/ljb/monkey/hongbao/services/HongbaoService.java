package ljb.monkey.hongbao.services;
...
import ljb.monkey.hongbao.util.HongbaoSignature;
import ljb.monkey.hongbao.util.PowerUtil;
...
public class HongbaoService extends AccessibilityService implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private static final String WECHAT_LUCKMONEY_RECEIVE_ACTIVITY = "luckymoney.ui";
    ...
    private void watchChat(AccessibilityEvent event) {
        ...
        Log.e("123","mUnpackCount =" +mUnpackCount +""+",mUnpackNode "+mUnpackNode);
        /* 如果戳开但还未领取 */
    ...
    private AccessibilityNodeInfo findOpenButton(AccessibilityNodeInfo node) {
        ...
        if (node.getChildCount() == 0) {
            Log.e("123","node.getClassName() "+node.getClassName());
            if ("android.widget.Button".equals(node.getClassName())){
                Log.e("123","findOpenButton" +" node "+node);
                return node;}
            else
                return null;
        }
    ...
    private void checkNodeInfo(int eventType) {
        ...
        if (node1 != null &&
            ...
            if (this.signature.generateSignature(node1, excludeWords)) {
                ...
                mReceiveNode = node1;
                Log.e("123", this.signature.toString());
            }
            return;
        }
        ...
        Log.e("123","node2 "+node2);
        Log.e("123","currentActivityName "+currentActivityName);
