package ljb.monkey.hongbao.activities;
...
import ljb.monkey.hongbao.R;
import ljb.monkey.hongbao.util.ConnectivityUtil;
import ljb.monkey.hongbao.util.UpdateTask;
...
public class MainActivity extends Activity implements AccessibilityManager.AccessibilityStateChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bugly.init(getApplicationContext(), "541bbed278", false);
    ...
    public void openGitHub(View view) {
        ...
        webViewIntent.putExtra("url", "https://github.com/haoxingren9999/RedPacket");
